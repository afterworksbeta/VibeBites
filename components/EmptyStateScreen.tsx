    ...
    <div className="flex flex-col h-full w-full bg-white font-['Press_Start_2P'] overflow-hidden animate-in fade-in duration-500">
      ...
      >
         ...
         <div className="absolute top-20 right-20 animate-pulse">
            <span className="text-black text-[24px] font-bold">?</span>
         </div>
         ...
         <div className="relative mb-10 flex flex-col items-center z-10">
            {/* Speech Bubble */}
            <div className="bg-white border-[3px] border-black px-4 py-2 mb-4 relative shadow-[4px_4px_0_rgba(0,0,0,0.2)] animate-bounce">
                <span className="text-black text-[12px] uppercase font-bold text-center leading-tight block">
                    WHERE R MY<br/>FRIENDS?
                </span>
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-4 h-4 bg-white border-r-[3px] border-b-[3px] border-black transform rotate-45"></div>
            </div>
            
            {/* Avatar as Character - Using a darker/lonely aesthetic seed */}
            <div className="grayscale contrast-125 filter drop-shadow-[0_10px_0_rgba(0,0,0,0.2)]">
                 <PixelAvatar seed="lonely_pixel_void_99" size={120} borderWidth={4} />
            </div>
         </div>

         {/* Title Box */}
         <div className="bg-black border-[4px] border-black ring-[3px] ring-[#FFD740] px-8 py-4 shadow-[8px_8px_0_rgba(0,0,0,0.3)] mb-4 z-10 relative">
            <div className="absolute inset-1 border-[2px] border-white pointer-events-none"></div>
            <h2 className="text-[#FF5252] text-[20px] uppercase text-center leading-tight tracking-wide font-bold">
                NO FRIENDS<br/>YET!
            </h2>
         </div>
         
         {/* Subtitle */}
         <div className="bg-[#FFD740] px-4 py-1 border-t-2 border-b-2 border-black/10">
             <span className="text-black text-[14px] uppercase font-bold tracking-wider">START CONNECTING!</span>
         </div>
      </div>
